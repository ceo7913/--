/*  anime.js v3.2.1 (c) 2020 Julian Garnier Released under the MIT license anime
 * js.com
...
!function (n, e) {
            ...
            d = {
                ...
                Elastic: function (n, e) {
                    ...
                    return function (n) {
                        return 0 === n || 1 === n
                            ? n
                            : -t * Math.pow(2, 10 * (n - 1)) * Math.sin(
                                (n - 1 - r / (2 * Math.PI) * Math.asin(1 / t)) * (2 * Math.PI) / r
                            )
                    }
                }
            },
        ...
        return i.rgb(n)
            ...
            : i.hex(n)
                ? (
                    ...
                    "rgba(" + parseInt(a[1], 16) + "," + parseInt(a[2], 16) + "," + parseInt(a[3], 16) +
                        ",1)"
                )
                : i.hsl(n)
                    ? function (n) {
                        var e,
                            t,
                            r,
                            a = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(n) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(
                                n
                            ),
    ...
    function D(n, e, t) {
        ...
        var o = document.createElement(n.tagName),
            u = n.parentNode && n.parentNode !== document
                ? n.parentNode
                : document.body;
        u.appendChild(o),
    ...
    function F(n, e, t, r) {
        var a,
            ...
            i = E(n).get(e) || u;
        return t && (t.transforms.list.set(e, i), t.transforms.last = e),
        r
            ? D(n, i, r)
            : i
    }
    ...
    function Y(n, e) {
        ...
        return a
            .map(function (n, t) {
                var r = i.obj(n) && !i.pth(n)
                    ? n
                    : {
                        value: n
                    };
                return i.und(r.delay) && (
                    r.delay = t
                        ? 0
                        : e.delay
                ),
                i.und(r.endDelay) && (
                    r.endDelay = t === a.length - 1
                        ? e.endDelay
                        : 0
                ),
                r
    ...
    var K = [],
        U = function () {
            ...
            return "undefined" != typeof document && document.addEventListener(
                "visibilitychange",
                function () {
            ...
            function () {
                n || nn() && en.suspendWhenDocumentHidden || !(K.length > 0) || (
